...
- **Recovering lost PIDs** - if you publish new data objects (<a href = 'https://nceas.github.io/datateam-training/training/create-data-packages-in-r.html#publish-an-object' target='_blank'>`publish_object`</a>) but forget to save the `PID`s, you can recover them with a query. For example, you can search for all data objects that are _not_ associated with a resource map _and_ are published using your ORCiD (`q=-resourceMap:*+AND+submitter:*XXXX-YYYY-ZZZZ-WWWW`)
