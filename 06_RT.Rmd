...
We use it for managing submissions, access issues etc. It consists of
...
5. People - option to add more people to the watchlist for a given ticket conversation  
...
7. Actions  
 + Reply - message the submittor/PI/all watchers  
 + Comment - attach internal message (no submitters)  
 + Open It - Open the ticket  
 + Stall - submitter has not responded in greater than 1 week  
...
## Email Templates
  ...
  [Methods](#methods)  
  [Data Files](#data)  
  [DOI and data set finalization](#DOI)  
  [Nesting](#nest)  
  [Finding multiple data sets](#multiple)  
  [Asking for approval](#approve)
  [Other FAQs](#faq)  
  
  
###  <a id="initial">Initial Response</a>
...
### <a id="abstract">Abstract comments</a>
...
### <a id="practices">Best Practices</a>
...
### <a id="DOI">DOI and data set finalization comments</a>
...
### <a id="policy">NSF ARC data submission policy</a>
...
###  <a id="multiple">Finding multiple data sets</a>
...
###  <a id="approve">Asking for approval</a>
