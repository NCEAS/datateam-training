...
5. People - option to add more people to the watchlist for a given ticket conversation. Note that user/ PI/ submitter email addresses should be listed as "Requestors". Requestors are only emailed on "Reply"s, not "Comments". Ensure your ticket has a Requestor before attempting to contact users/ PIs/ submitters.   
