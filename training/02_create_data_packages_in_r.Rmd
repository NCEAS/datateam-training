...
To test for package structure correctness (system metadata, resource maps, distribution URLS) and congruence of the package's data and metadata, run the `qa_package()` function from the `datamgmt` package. 
