...
This chapter will teach you how to create and submit a data package to a DataONE MN via R. But first, please read [this paper](https://nceas.github.io/datateam-training/training/data/eml-principles.pdf) on the value of structured metadata, namely the Ecological Metadata Language (EML).
