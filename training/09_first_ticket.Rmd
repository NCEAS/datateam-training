...
* Take the ticket
* Take a moment to read over any corresponence there might be
* If there isn't already a requestor email add it
...
We have developed some partially filled R scripts to help you out on working on your first dataset. You can use this  [fill in the blanks example](data/dataset_processing_example_blanks.R) to get familiar with the function we use and work flow first. We also have a more minimal example [A filled example](dadataset_processing_example_skeleton.R_.R) for a intermediate step. You can look at the [filled example](data/dataset_processing_example_filled.R) if you get stuck or message the #datateam slack channel.

## Review

Once you have updated the dataset to your satisfaction, post the link to the dataset on #datateam for peer review.
