...
knitr::opts_chunk$set(eval = F, collapse = TRUE)
```
...
## Creating a new Parent package example
...
```{r}
eml_parent@dataset@title <- read_eml('<title>Time series of water temperature, specific conductance, and oxygen from Lake E1, North Slope, Alaska, 2012-2014</title>')
```
