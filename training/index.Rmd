...
* <a href = 'https://identity.nceas.ucsb.edu/identity/cgi-bin/ldapweb.cgi?cfg=account' target='_blank'>LDAP-NCEAS</a> - this should be set up prior to your start date in order to help get other accounts set. This account and password control your access to:
...
via your UCSBNetID and password.  Log your hours for you first day! Under today's date select 'Hours Worked' under the Pay Code column, enter the amount of hours under the Amount column, and finally click the 'Save' button in the top right. At the end of every two-week pay period you will also need to click the 'Approve Timecard' button in order to submit your timecard.  <a href = 'https://timekeeping.ucsb.edu/sites/default/files/employee_hours_worked_0.pdf' target='_blank'>Detailed instructions</a>
