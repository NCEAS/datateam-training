...
```{block, type = "note"}
This chapter will be longest of all 10 sections! This is a reminder to take frequent breaks when completing this section.
```
...
* Make sure your package from [before](#exercise-3a) is loaded into R.
* Write, validate, and update your package.
