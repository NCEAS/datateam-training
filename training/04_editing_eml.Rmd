...
The diagrams from the DataOne Community Meeting (Session 7) illustrate the dataset submission workflow explicitly.

![](images/data-submission-workflow1.png)

![](images/data-submission-workflow2.png)
...
Note that there is a bug existing for `qa_package()` in test web which will show you the following error message when you run the function.
```
...
This is normal for now becasue of the existing bug. It will be fixed later so please ignore this error message for now. 
