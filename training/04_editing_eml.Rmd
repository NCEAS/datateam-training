...
Note that there is a bug existing for qa_package() which will show you the following error message when you run the function.
```
...
The bug will be fixed later so please ignore this error message for now. 
