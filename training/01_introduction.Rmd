...
Read Matt Jones et al.'s paper on <a href = 'https://github.com/NCEAS/datateam-training/blob/master/training/data/simple-guidelines-datamgmt.pdf' target='_blank'>effective data management</a> to learn how we will be organizing datasets prior to archival.
