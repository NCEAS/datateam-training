...
We access RStudio on our server through this [link.](https://datateam.nceas.ucsb.edu/rstudio/) To transfer files on and off of the server we often use our NCEAS secure FTP client, Cyberduck.
