...
We use the Ecological Metadata Language (EML) to store structured metadata for all datasets submitted to the Arctic Data Center. For additional background on EML and principles for metadata creation, check out [this paper](data/eml-principles.pdf).
...
```{r, child = '../workflows/edit_eml/explore_eml.Rmd'}
```
