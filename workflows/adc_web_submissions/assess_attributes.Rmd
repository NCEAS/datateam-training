...
New submissions made through the web editor should have attributes created by the submitter. If there are no or incomplete attributes, please use the [email template](#need-attributes) to correspond with the submitter to ask for attributes.
