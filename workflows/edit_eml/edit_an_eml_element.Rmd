...
This inserts the abstract with a `para` element in our dataset, which we know from the EML [schema](https://knb.ecoinformatics.org/external//emlparser/docs/eml-2.1.1/index.html) is valid.
