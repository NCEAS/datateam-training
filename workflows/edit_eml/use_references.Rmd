...
*Note: Do not use references for creators as it is used for the citation information.* The creators will not show up on the top of the dataset if it is a reference. Until this issue is resolved  in NCEAS/metacat#926 we will need to keep this in account.
