...
Additionally, spatial data should typically be archived within a compressed .zip file in order to reduce file sizes. Also note that shapefiles limit attribute names to 10 characters, so attribute names in the metadata may not match exactly to attribute names in the data.
