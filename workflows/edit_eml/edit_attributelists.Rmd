...
Once you are done editing a table in the app, quit the app and the tables will be returned as a list. Alternatively, each table can be to exported to a csv file by clicking the `Download` button.

Read the table back into your R session and assign it to a variable in your script (e.g. `attributes <- data.frame(...)`).
