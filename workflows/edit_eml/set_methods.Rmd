...
The methods tree in the EML section has many different options, visible in the [schema](https://eml.ecoinformatics.org/schema/index.html). You can create new elements in the methods tree by following the schema and using the `eml` helpers.
