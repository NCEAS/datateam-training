...
To remove an `otherEntity` use the following command. This may be useful if a data object is originally listed as an `otherEntity` and then transfered to a `dataTable`.
