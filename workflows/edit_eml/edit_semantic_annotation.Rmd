...
The training will cover an overview of what areas we usually will need to update. For more information on how to add semantic annotations to EML 2.2.0 can be found [here](https://eml.ecoinformatics.org/semantic-annotation-primer.html)

## How annotations are used

This is a [dataset](https://arcticdata.io/catalog/view/doi%3A10.18739%2FA2KW57J9Q) that have semantic annotations included.
...
```{r}
doc$dataset$dataTable[[1]]$attributeList$attribute[[3]]$annotation$propertyURI

doc$dataset$dataTable[[1]]$attributeList$attribute[[3]]$annotation$valueURI
```

## Ontologies used

### [OBOE: The Extensible Observation Ontology](https://github.com/NCEAS/oboe)

This ontology covers the following:
...
All the classes can be found [on bioPortal](https://bioportal.bioontology.org/ontologies/OBOE/?p=classes). You will need the ID (`propertyURI`) and the label from the relevant entry. If you are unsure, ask Jasmine or Jeanette about what appropriate annotations to use.
