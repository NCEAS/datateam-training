...
Note that when read kml files, read_sf() sometimes can generate columns which do not exist in the original files. Be aware of this and always open kml files in text editor to check the existence of columns.
