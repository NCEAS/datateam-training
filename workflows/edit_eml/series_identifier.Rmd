...
A series identifier is a system metadata field that represents a persistent identifier for a data package.  These are useful for maintaining a single identifier when a data package is expected to receive updates (usually additional data) in the future.  
