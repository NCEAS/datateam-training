...
If a award title cannot be found you can use the dataset title.

Information can be found in using the  <a href = 'https://gitlab.com/crossref/open_funder_registry/-/tree/master' target='_blank'>Open Funder Registry</a>
