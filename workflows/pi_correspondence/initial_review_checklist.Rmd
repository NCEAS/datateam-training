...
* Abstract
  + Describes the DATA as well as:
    ...
    - At least one sentence summarizing general methodolgies
    - NO UNDEFINED ACRONYMS, ABBREVIATIONS, nor INITIALISMS unless approved of as being more widely-known in that form than spelled out
...
* Data
  ...
  + Each file is well NAMEd and DESCRIBEd and clearly differntiated from all others
...
* Methods
  ...
  + Enough detail is provided such that a reasonable scientist could interpret the study and data for reuse without needing to consult the researchers, nor any other resouces
