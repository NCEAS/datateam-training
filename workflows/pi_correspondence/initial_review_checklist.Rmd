...
- **Social Science:** Any dataset involving human subjects (may include awards awarded by ASSP, topics such as COVID-19)
- **Archaeology:** archaeological site location information, which is protected from public access by law
- **Biology:** protected species coordinates

If any of the above applied to the dataset, please let the rest of the team know before proceeding.
