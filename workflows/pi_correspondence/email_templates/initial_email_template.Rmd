...
> I noticed that your dataset had incomplete attribute/variable information. Can you please add attribute/variable information to each of your data files by clicking on the `Describe` button located to the right of each of your files at the top of the submission page located here https://beta.arcticdata.io/catalog/#submit/[INSERT EML PID HERE]. Please see the guidance below for what attribute/variable information should contain.
