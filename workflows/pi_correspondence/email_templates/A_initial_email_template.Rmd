...
> Hello _____,
> Thank you for your recent submission to the NSF Arctic Data Center! We will review your data set and get back to you with any suggestions.
> 
...
> I noticed that your data set has incomplete attribute/variable information. Can you please add attribute/variable information to each of your data files by clicking on the "Describe" button located to the right of each of your files at the top of the submission page located here https://beta.arcticdata.io/catalog/#submit/[INSERT EML PID HERE] and then click over to the "Attributes" tab. Please see the guidance below for what attribute/variable information should contain.
