...
1. Non-sensitive data(None of the data includes sensitive or protected information.(
...
3. Some or all data is sensitive with significant risk(The data contains human subjects data or other sensitive data. Release of the data could cause harm or violate statutes, and must remain confidential following restrictions from an Institutional Review Board (IRB) or similar body.
