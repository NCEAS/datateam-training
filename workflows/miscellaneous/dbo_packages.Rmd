...
DBO packages are organized under a project page (viewable [here](https://arcticdata.io/catalog/projects/DBO)). In order to make sure that DBO datasets appear in the special DBO data search correctly, there are a few additional metadata requirements.
...
After you have updated your dataset, navigate to [https://arcticdata.io/catalog/projects/DBO/data](https://arcticdata.io/catalog/projects/DBO/data) and make sure that the different filters work as expected. Your dataset should be discoverable in some way through all of the filters.
