...
Now we can update your data package to include the new metadata file using `replaceMember`
```{r, eval = F}
...
Once you are happy with your changes you can publish the package by using a UUID or DOI.
