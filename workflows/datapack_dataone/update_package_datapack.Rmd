...
pkg <- getDataPackage(d1c_test, identifier=packageId, lazyLoad=TRUE, quiet=FALSE)
```
...
```{r, eval = FALSE}
newPackageId <- uploadDataPackage(d1c_test, pkg, public=FALSE, quiet=FALSE)
```
...
newPackageId <- uploadDataPackage(d1c_test, pkg, public=TRUE, quiet=FALSE)
``` 
