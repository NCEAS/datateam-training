...
- **Descriptive title:** what, where, when - provides enough information to understand the contents at a general scientific level (only first word and proper nouns capitalized, as in a journal article title; do not add a period at the end, it will auto-populate)
    - Ex: "Active layer soil bulk density, moisture, carbon and nitrogen concentrations, and stable isotope data from Alaska borehole sites, 2015"
...
- **Creator and contact roles** are complete
      ...
      in the `userId` slots. Note the "s" in "https". See how to do this in an automated fashion [here](https://nceas.github.io/datateam-training/training/editing-eml-in-r.html#edit-an-eml-element)  
...
- **Geographic and temporal ranges** are sensible (start date preceeds end date) and appropriate to the study site and period; geogrpahic description is accurate and inlcudes generally understood context
...
- **Methods:** provide enough detail so that a reasonable scientist can interpret and reuse the data without needing to consult anyone nor any other resources
