...
- After approval and DOI'ing, ensure all versions (of all objects) following a public version, are also public. Use `arcticdatautils::set_public_read()` if needed.
