...
1) Open Cyberduck.
2) Check that you have the latest version (Cyberduck -> Check for Update...). If not, download and install the latest (you may need Dom, Jesse, or Jeanette to enter a password).
