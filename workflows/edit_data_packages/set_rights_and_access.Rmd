...
Note, when setting metadata, the ORCiD must start with `http://`. ORCiDs in eml should start with `https://`. The `sub` comman above will change this formatting for you.
