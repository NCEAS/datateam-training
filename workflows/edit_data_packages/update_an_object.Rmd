...
The `arcticdatautils::update_object` function updates a data object but does not change the resource map or EML. To simultaneously update all three parts of a data package, you can use the `datamgmt::update_package_object` function.
...
To try it out for yourself, you can run this code to create a dummy package on [test.arctic.io](https://test.arctic.io) and update an object.
