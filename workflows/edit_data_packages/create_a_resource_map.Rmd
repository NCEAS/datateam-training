...
Once all the objects that ought to belong to the package have been published, create a resource map using their respective PIDs (or the varibales you saved the PIDs to) via the `arcticdatautils::create_resource_map()` function, like so:
