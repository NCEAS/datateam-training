...
Note that we called the object `doc`. This is a good generic name to use for EML documents. The generic name `eml` should not be used - as the EML package ships with an `eml` function, which can cause namespace issues in your environment if you have an object also called `eml`.
