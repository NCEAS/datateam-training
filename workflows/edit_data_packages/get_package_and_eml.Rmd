...
Before we look more in depth at EML, we first need to load your data package into R. After [setting your node](#set-dataone-nodes), use the following commands to load the package:
