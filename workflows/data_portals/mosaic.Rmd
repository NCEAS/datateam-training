...
**When working MOSAiC datasets:**

- Will need to find out the `EventId` from the researcher to annotate (`Campaign` can be derived from the `EventId`).
- There is a custom ontology for the datasets are currently in the [sem-prov-ontologies](https://github.com/DataONEorg/sem-prov-ontologies/blob/main/MOSAiC/MOSAiC.owl) repository but you shouldn't need to use it directly and copy paste from Protoge if the function works.
...
2. [Example with MOSAiC and ECSO annotations](https://doi.org/10.18739/A23F4KP3J)
