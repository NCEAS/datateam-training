...
There the portal is on DataONE here: https://search.dataone.org/portals/mosaic/Data

### Custom Ontology

There is a custom ontology for the datasets (the ontology will be available publicly shortly). 
...
```{r}
leg1 <- list(propertyURI = list(label = "isPartOfCampaign", 
                          propertyURI = "http://purl.dataone.org/odo/MOSAiC_00000032"), 
       valueURI = list(label = "PS122/2", 
                       valueURI = "http://purl.dataone.org/odo/MOSAiC_00000018"))

leg2 <- list(propertyURI = list(label = "isPartOfCampaign", 
                          propertyURI = "http://purl.dataone.org/odo/MOSAiC_00000032"), 
       valueURI = list(label = "PS122/2", 
                       valueURI = "http://purl.dataone.org/odo/MOSAiC_00000018"))
leg3 <- list(propertyURI = list(label = "isPartOfCampaign", 
                          propertyURI = "http://purl.dataone.org/odo/MOSAiC_00000032"), 
       valueURI = list(label = "PS122/2", 
                       valueURI = "http://purl.dataone.org/odo/MOSAiC_00000018"))

leg4 <- list(propertyURI = list(label = "isPartOfCampaign", 
                          propertyURI = "http://purl.dataone.org/odo/MOSAiC_00000032"), 
       valueURI = list(label = "PS122/2", #*** this changes depending on the leg
                       valueURI = "http://purl.dataone.org/odo/MOSAiC_00000018"))

leg5 <- list(propertyURI = list(label = "isPartOfCampaign", 
                          propertyURI = "http://purl.dataone.org/odo/MOSAiC_00000032"), 
       valueURI = list(label = "PS122/2", #*** this changes depending on the leg
                       valueURI = "http://purl.dataone.org/odo/MOSAiC_00000018"))
```
